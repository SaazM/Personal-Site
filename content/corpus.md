# Corpus — everything the avatar is allowed to know

Hand-edit this file like the rest of the site. The avatar can only speak from
what's written here; anything not covered gets "I haven't written about that —
email me."
...
actually work. Email: saaz.m@icloud.com. GitHub: github.com/SaazM.
...
[TODO: paste the full text of each essay so the avatar can quote and
paraphrase accurately. Until then it only knows the summaries below.]

- "The Human's Role in Engineering" (Jul 2026) — notes on the human role in
  engineering, post-agents.
- "We Made Applying Easier. Did We Make Hiring Worse?" (Apr 2026) — why
  getting a job feels harder in the biggest tech boom in decades.
- "Why Leetcode Fails in the AI Era" (Apr 2026) — nobody liked LeetCode to
  begin with; now it measures the wrong thing entirely.

More writing: saazmahadkar.substack.com

## Views / opinions

[TODO: write this — the section that makes the avatar you. Positions you'd
stand behind on hiring, AI in engineering, what you look for in teammates,
what you're optimizing for in your career. The avatar will not improvise
opinions that aren't here.]
